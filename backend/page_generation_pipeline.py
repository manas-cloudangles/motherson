...
- For buttons: <app-button>Button Text</app-button>
- For headers: <app-header></app-header>
- For footers: <app-footer></app-footer>
- Use the available components listed above in your HTML (unless they violate user preferences)
